...
def parse_args():
    ...
    parser.add_argument('--aux_beh_idx', nargs='?', default='[0,1]') #+1
    parser.add_argument('--all_beh_idx', nargs='?', default='[0,1,2]')#+1
    ...
    parser.add_argument('--ssl_reg_inter', nargs='?', default='[1,1,1]')#+1
